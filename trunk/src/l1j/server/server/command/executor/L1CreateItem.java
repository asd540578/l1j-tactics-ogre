...
public class L1CreateItem implements L1CommandExecutor
{
	...
	public void execute(L1PcInstance pc, String cmdName, String arg)
	{
		try
		{
			...
			{
				int duplicate = ItemTable.getInstance()
						.findItemIdCountByNameWithoutSpace(nameid);
				if (duplicate >= 2)
				{
					pc.sendPackets(new S_SystemMessage(ItemTable.getInstance()
							.findItemIdsByNameWithoutSpace(nameid).concat("から選択してください。")));
					return;
				}
				else
				{
