...
import l1j.server.server.templates.L1BeginnerItem;
...
public class C_CreateChar extends ClientBasePacket {
	...
	// private static final short[] MAPID_LIST = new short[] { 68, 69, 69, 68,
	// 69,
	// 69, 69 };
	...
	private static void giveBeginnerItems(L1PcInstance pc) {
		List<L1BeginnerItem> items = L1BeginnerItem.findByClass(pc
				.getClassFeature().getClassNameInitial());

		for (L1BeginnerItem item : items) {
			item.storeToInventory(pc.getId());
		}
	}
